...
const router = useRouter();
  ...
  try {
    ...
    const apiEndpoint = "https://nfgfx2bpj6.execute-api.us-east-1.amazonaws.com/ProdUser/ResetPassword";
    const body = { body: JSON.stringify({ token: token,newPassword: values.password }) };
