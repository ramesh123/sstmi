...
export default function LoginPage() {
  ...
  const sssssssssssss = async () => {
    ...
    try {
      const response = await fetch('https://nfgfx2bpj6.execute-api.us-east-1.amazonaws.com/ProdUser/user/login', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        // Success
        setToast({ message: 'Login successful! Welcome to Sri Subramanya Swamy Cultural Center!', type: 'success' });
                ...
                <button
                  ...
                  style={{
                    ...
                    background: isLoading 
                      ? '#9ca3af' 
                      : 'linear-gradient(to right, #00BFFF, #0080FF)',
                    border: 'none',
                    borderRadius: '50px',
