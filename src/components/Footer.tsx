...
export default function Footer() {
  ...
  const DevoteesIconUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWi-aIycN_LquDmXW0QQSYMMZqEaU2IGfvA2KIC0GiGIO2Y61qUlbGTWs&s";
    ...
    <footer id="Contact" className="bg-gradient-to-r from-yellow-100 to-yellow-300 py-12 text-gray-800">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a
                href="https://forms.gle/ycpuzicid78i5uyB9"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 bg-white p-3 rounded-lg shadow-md hover:shadow-lg transition"
              >
                <img src={DevoteesIconUrl} alt="Devotees Icon" className="h-5 w-5" />
                <span>Devotees Signup</span>
              </a>
              <a
        ...
        <p className="text-center text-gray-600 mt-12">
          &copy; 2025 Sri Subramanya Swamy Cultural Center. All Rights
          Reserved.
        </p>
      </div>
